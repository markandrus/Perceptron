module Misc (shuffle) where

import System.Random

{- Thanks to http://okmij.org/ftp/Haskell/perfect-shuffle.txt for shuffle algorithm -}
...
shuffle :: [a] -> [a]
shuffle xs = shuffle1 xs (fst $ make_rs (length xs-1) (mkStdGen 17))
